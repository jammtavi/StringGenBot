...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@zenupdatess"))
        else:
            ...
            await client.join_chat("zenupdatess")
    except KeyError:
        pass
    try:
